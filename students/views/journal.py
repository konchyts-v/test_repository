...
class JournalView(TemplateView):
	...
	def get_context_data(self, **kwargs):
		...
		# check if we need to display some cpecific month
		...
		# for all students and get data need
		students = []
		...
		# apply pagination to student's list
	...
	def post(self, request, *args, **kwargs):
		...
		# set new presence or journal for given student and save result
		setattr(journal, 'present_day%d' % current_date.day, present)
		journal.save()

		# return success status
		return JsonResponse({'status': 'success', 'key': 'success'})